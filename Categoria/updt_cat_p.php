...
if (isset ( $_GET['id_cat'])){
	...
	$update = mysqli_query($conexion, "UPDATE categoria_prod SET nombre='".$nombre."', descripcion='".$descr."' WHERE id_cat = '".$codigo."';")or die ( "Error en query: $update, el error  es: " . mysqli_error());
