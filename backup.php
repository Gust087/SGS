...
/* Conexion y eso*/
$conexion = mysqli_connect("localhost", "root", "", "db_sistema_stock") OR DIE("No ha sido posible conectar a la tabla");
...
if ( empty($tablas) ) {
    ...
    $respuesta = mysqli_query($conexion, $consulta);
		...
		while ($fila = mysqli_fetch_array($respuesta, MYSQLI_BOTH)) {
			$tablas[] = $fila[0];
			}
}
